...
class server(threading.Thread):
    ...
    def run(self, s, addr):
        ...
        #     exit()
        s.send(b"Server: Preparing to receive the file from the client...")
        ...
        while file_count > 0:
            ...
            print("Server: receiving image {}...".format(file_name))
...
if __name__ == '__main__':
    ...
    while True:
        sock, addr = s.accept()
        t = threading.Thread(target=se.run, args=(sock, addr))
        t.start()
        # time.sleep(3)
